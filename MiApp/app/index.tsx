...
import { crearMision } from '../services/api';
...
export default function HomeScreen() {
  ...
  useEffect(() => {
    async function lockHomeOrientation() {
  ...
  const register = () => {
    registerUser(email, password)
      .then(() => {
        ...
        Alert.alert('Registro', 'Usuario creado');
      })
    ...
    <View style={styles.window}>
      <View style={styles.topBar}>
        <TouchableOpacity activeOpacity={0.8} style={styles.statusPill}>
          ...
          <MaterialIcons name="arrow-drop-down" size={22} color="#f23b3f" />
        </TouchableOpacity>
        ...
        <View style={styles.topBarRight}>
          ...
          >
            <MaterialIcons name={loggedUser ? 'person' : 'person-outline'} size={18} color="#f23b3f" />
          ...
          >
            <MaterialIcons name="settings" size={20} color="#f23b3f" />
          </TouchableOpacity>
        </View>
      </View>
            ...
            {loggedUser ? (
              <>
                <View style={{ flexDirection: 'row', alignItems: 'center', gap: 10, marginBottom: 20 }}>
                  <MaterialIcons name="person" size={22} color="#f23b3f" />
